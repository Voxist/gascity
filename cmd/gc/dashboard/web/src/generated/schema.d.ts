...
export interface components {
    schemas: {
        ...
        BreakerStateChangedPayload: {
            /**
             * Format: int64
             * @description Open-state backoff chosen for this episode, in milliseconds.
             */
            backoff_ms?: number;
            /**
             * Format: int64
             * @description Consecutive transport-failure count at the change.
             */
            failures?: number;
            /** @description Breaker state before the transition. */
            from: string;
            /** @description Operation class, e.g. bd. */
            op_class: string;
            /** @description Store scope (canonical scope root path). */
            scope: string;
            /** @description Breaker state after the transition. */
            to: string;
        };
        CityCreateRequest: {
            /**
        ...
        ControllerTickCompletedPayload: {
            /**
             * Format: int64
             * @description Wall-clock duration of the completed tick, in milliseconds.
             */
            duration_ms: number;
            /** @description Tick trigger phase: patrol, poke, control-dispatcher, etc. */
            phase: string;
            /** @description True when emitted due to a duration-threshold breach rather than the patrol multiple. */
        ...
        DoctorAlertPayload: {
            /** @description Name of the doctor check that went red. */
            check: string;
            /** @description City name the check evaluated, when scoped to a city. */
            city?: string;
            /** @description Human-readable description of the red condition. */
            detail: string;
            /** @description Optional subject identifier (scope, path) the alert concerns. */
            subject?: string;
        };
        ErrorDetail: {
        ...
        EventPayload: components["schemas"]["AdapterEventPayload"] | components["schemas"]["BeadEventPayload"] | components["schemas"]["BeadWorktreeReapSkippedPayload"] | components["schemas"]["BeadWorktreeReapedPayload"] | components["schemas"]["BoundEventPayload"] | components["schemas"]["BreakerStateChangedPayload"] | components["schemas"]["CityCreateSucceededPayload"] | components["schemas"]["CityLifecyclePayload"] | components["schemas"]["CityUnregisterSucceededPayload"] | components["schemas"]["ControllerTickCompletedPayload"] | components["schemas"]["DoctorAlertPayload"] | components["schemas"]["GroupCreatedEventPayload"] | components["schemas"]["InboundEventPayload"] | components["schemas"]["MailEventPayload"] | components["schemas"]["NoPayload"] | components["schemas"]["OrderGateTimeoutFailOpenPayload"] | components["schemas"]["OutboundEventPayload"] | components["schemas"]["PostgresCredentialResolvedPayload"] | components["schemas"]["ProjectIdentityStampedPayload"] | components["schemas"]["ProxyReapedPayload"] | components["schemas"]["QuotaObservedPayload"] | components["schemas"]["QuotaPollFailedPayload"] | components["schemas"]["RequestFailedPayload"] | components["schemas"]["RotatedPayload"] | components["schemas"]["SessionCreateSucceededPayload"] | components["schemas"]["SessionDrainAckedWithAssignedWorkPayload"] | components["schemas"]["SessionLifecyclePayload"] | components["schemas"]["SessionMessageSucceededPayload"] | components["schemas"]["SessionResetStalledPayload"] | components["schemas"]["SessionSubmitSucceededPayload"] | components["schemas"]["StoreDegradedPayload"] | components["schemas"]["StoreDiskCriticalPayload"] | components["schemas"]["StoreDiskWarnPayload"] | components["schemas"]["StoreMaintenanceDonePayload"] | components["schemas"]["StoreMaintenanceFailedPayload"] | components["schemas"]["StoreProbeFailedPayload"] | components["schemas"]["StoreRecoveredPayload"] | components["schemas"]["SupervisorFSPressureSkippedTickPayload"] | components["schemas"]["SupervisorRequestPayload"] | components["schemas"]["SupervisorShutdownPayload"] | components["schemas"]["UnboundEventPayload"] | components["schemas"]["WorkerOperationEventPayload"];
        EventRotateAnchor: {
            /**
             * Format: int64
        ...
        ProxyReapedPayload: {
            /**
             * Format: int64
             * @description Number of db-proxy-child PIDs signaled.
             */
            pids_signaled: number;
            /** @description Directory holding the pre-reap forensic artifacts. */
            quarantine_dir: string;
            /** @description True when a second poison inside the window suppressed the reap (forensics kept, alert-only). */
            rate_limited?: boolean;
            /** @description Canonical scope root path whose db-proxy child was reaped. */
            scope: string;
        };
        PublishReceipt: {
            Conversation: components["schemas"]["ConversationRef"];
        ...
        StoreDegradedPayload: {
            /** @description Degradation class: transport, backend, or write-rejection. */
            class: string;
            /**
             * Format: int64
             * @description Consecutive failed probe cycles at the trip.
             */
            consecutive_fails?: number;
            /** @description Human-readable cause from the failing probe. */
            reason?: string;
            /** @description Canonical scope root path whose store degraded. */
            scope: string;
        };
        ...
        StoreProbeFailedPayload: {
            /** @description Which probe failed: routed (probe A) or backend (probe B). */
            probe: string;
            /** @description Human-readable cause from the failing probe. */
            reason?: string;
            /** @description Canonical scope root path of the failing probe. */
            scope: string;
        };
        StoreRecoveredPayload: {
            /** @description Degradation class that recovered, if known. */
            class?: string;
            /** @description Canonical scope root path whose store recovered. */
            scope: string;
        };
        ...
        TypedEventStreamEnvelopeBreakerStateChanged: {
            actor: string;
            message?: string;
            payload: components["schemas"]["BreakerStateChangedPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
        ...
        TypedEventStreamEnvelopeControllerTickCompleted: {
            actor: string;
            message?: string;
            payload: components["schemas"]["ControllerTickCompletedPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
        ...
        TypedEventStreamEnvelopeDoctorAlert: {
            actor: string;
            message?: string;
            payload: components["schemas"]["DoctorAlertPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
        ...
        TypedEventStreamEnvelopeOrderGateTimeoutFailOpen: {
            actor: string;
            message?: string;
            payload: components["schemas"]["OrderGateTimeoutFailOpenPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
        ...
        TypedEventStreamEnvelopeProviderQuotaObserved: {
            actor: string;
            message?: string;
            payload: components["schemas"]["QuotaObservedPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
        ...
        TypedEventStreamEnvelopeProviderQuotaPollFailed: {
            actor: string;
            message?: string;
            payload: components["schemas"]["QuotaPollFailedPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
        ...
        TypedEventStreamEnvelopeProxyReaped: {
            actor: string;
            message?: string;
            payload: components["schemas"]["ProxyReapedPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
        ...
        TypedEventStreamEnvelopeStoreDegraded: {
            actor: string;
            message?: string;
            payload: components["schemas"]["StoreDegradedPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
        ...
        TypedEventStreamEnvelopeStoreProbeFailed: {
            actor: string;
            message?: string;
            payload: components["schemas"]["StoreProbeFailedPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
        ...
        TypedEventStreamEnvelopeStoreRecovered: {
            actor: string;
            message?: string;
            payload: components["schemas"]["StoreRecoveredPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
