...
type SessionConfig struct {
	...
	// a desired, alive, claim-less pool session on a healthy provider whose last
	...
	// not self-recover. Duration string (e.g. "45m"). Unset/zero disables it.
	// (ADR-0013 A1 M3b)
...
// ProgressStallTimeoutDuration returns the progress-stall recycle timeout,
// or 0 when unset or unparseable. Zero disables progress-aware recycling.
